...
System.register(['aurelia-framework', 'aurelia-fetch-client', 'periscope-framework', 'lodash'], function (_export, _context) {
  "use strict";

  var inject, HttpClient, SchemaProvider, _, _dec, _class, ElasticSearchSchemaProvider;
  ...
  return {
    ...
    execute: function () {
      _export('ElasticSearchSchemaProvider', ElasticSearchSchemaProvider = (_dec = inject(HttpClient), _dec(_class = function (_SchemaProvider) {
